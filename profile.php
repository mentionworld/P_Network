	...
	<div class="row">
		...
		<div class="col-sm-8">
			<?php
				...
				"
					<div>
						<div><img id='cover-img' class='img-rounded' src='cover/$user_cover' alt='cover' height='430px' width='850px'></div>
						<form action='profile.php?u_id=$user_id' method='post' enctype='multipart/form-data'>

							<ul class='nav pull-left' style='position:absolute; top:10px ; left=40px;'>
								<li class='dropdown'>
									<button class='dropdown-toggle btn btn-default' data-toggle='dropdown' type = 'button'>Change Cover</button>
									<div class='dropdown-menu'>
										<center><p>Click<strong>Select Cover</strong>and then click the <br><strong>Update Cover</strong></p>
			...
			<?php
				if(isset($_POST['submit']))
				{
					...
					if ($u_cover=='') 
					{
						echo "<script>alert('Please Select Cover Image')</scrip";
					...
					else
					{
						...
						if ($run) 
						{
							echo "<script>alert('Your Cover Updated')</scrip";
							echo "<script> window.open('profile.php?u_id=$user_id','_self')</script>";
		...
		<div class="col-sm-2" style="background-color: #e6e6e6; text-align: center;left: 0.8%;border-radius: 5px;">
			<?php
				echo "
					...
					<p><strong><i >Relationship status:</i></strong>$Relationship_status</p><br>
					<p><strong><i >Live in:</i></strong>$user_country</p><br>
					<p><strong><i >Member Since:</i></strong>$register_date</p><br>
					<p><strong><i >Gender:</i></strong>$user_gender</p><br>
					<p><strong><i >Date of Birth:</i></strong> $user_birthday</p><br>
			...
			<?php
				...
				global $con;
						...
						if(isset($_GET['u_id']))
						{
							...
							$get_posts="select user_email from users where user_id='$uu_id'";
