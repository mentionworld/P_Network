	...
	<div class="row">
		<div class="col-sm-12">
			<div class="main-content">
				<div class="header">
					<h3 style="text-align: center;"><strong> Join mention world</strong></h3>
				</div>
				<div class="l-part">
					<form action="" method="post">
						...
						<a style="text-decoration: none; float: right;color: #187FAB;" data-toggle="tooltip" title="Create your account" href="signup.php"> Don't have any account?</a><br><br>
